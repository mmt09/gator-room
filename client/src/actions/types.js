...
export const FETCH_LISTING_UPLOAD = 'fetch_listing_upload';
export const UPLOAD_LISTING_FILTERS = 'upload_listing_filters';
export const REMOVE_UPLOADED_LISTING_ID = 'remove_uploaded_listing_id';
