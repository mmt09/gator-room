...
import landLordListings from './landlord_listings_reducer';
import listingLandlordReducer from './listing_landlord_reducer';
...
export default combineReducers({
  ...
  listingLandlord: listingLandlordReducer,
});
